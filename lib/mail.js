...
var X_MAILER_NAME = "Nodemailer",
    X_MAILER_VERSION = "0.2.4; +http://www.nodemailer.org";
 ...
 *     cid is optional.
 *   - **body_content_type** (optional) force the content-type of the body
 *   - **body_encoding** (optional) force the encoding of the body different than global encoding
 *
...
function EmailMessage(params){
    ...
    this.body_content_type = params.body_content_type || "text/plain; charset="+this.charset;
    this.body_encoding = params.body_encoding || this.encoding;

    this.xoauth = params.xoauth
...
EmailMessage.prototype.prepareVariables = function(){
    ...
    //'?' is not in any known base64 extension
        ...
        this.content_type = this.body_content_type;
        this.content_transfer_encoding = this.body_encoding;
    }
};
...
EmailMessage.prototype.generateBody = function(){
    ...
    rows.push("Content-Type: "+this.body_content_type);
    rows.push("Content-Transfer-Encoding: "+this.body_encoding);
    rows.push("");
